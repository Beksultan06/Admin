...
router.register(
    "generalInformation", GeneralInformationViewSet, basename="GeneralInformation"
)
router.register("passport", PassportViewSet, basename="passport")
router.register(r"Infos", InfoAPIV, basename="info")
router.register(
    r"HeadPersonalityAPI", HeadPersonalityAPI, basename="HeadPersonalityAPI"
)
...
urlpatterns = [
    ...
    path(
        "PersonalityAPI/<int:pk>/",
        PersonalityAPI.as_view({"get": "retrieve"}),
        name="PersonalityAPI",
    ),
]
