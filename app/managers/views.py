...
class Structure_adminsViewSet(viewsets.GenericViewSet, mixins.ListModelMixin):
    queryset = Structure_admins.objects.all()
    serializer_class = Structure_adminsSerializers


class ScheduleViewSet(viewsets.GenericViewSet, mixins.ListModelMixin):
