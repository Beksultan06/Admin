...
class NewsSerializer(serializers.ModelSerializer):
    class Meta:
        model = News
        fields = ['id','title_news','description_news','date_news','image_news','first_paragraph','second_paragraph','general_paragraph',]

class MediaSerializer(serializers.ModelSerializer):
    class Meta:
        model = Media
        fields = ['id','title_media','description_media','date_media','image_media',]
