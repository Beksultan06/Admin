...
from app.news.serializers import NewsSerializer, MediaSerializer, NewsNokSerializer, AboutNokSerializer, TourismNokSerializer
...
class NewsNokAPI(GenericViewSet,
                    mixins.ListModelMixin,
                    mixins.RetrieveModelMixin
                ):
...
class AboutNokAPI(GenericViewSet,
                    mixins.ListModelMixin,
                    mixins.RetrieveModelMixin
                ):
