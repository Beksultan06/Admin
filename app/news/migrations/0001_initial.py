    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description_media",
                    models.TextField(verbose_name='Описание СМИ страницы "Новости"'),
                ),
                (
                    "description_media_ru",
                    models.TextField(
                        null=True, verbose_name='Описание СМИ страницы "Новости"'
                    ),
                ),
                (
                    "description_media_ky",
                    models.TextField(
                        null=True, verbose_name='Описание СМИ страницы "Новости"'
                    ),
                ),
                (
                    "date_media",
                    models.DateTimeField(verbose_name='Дата СМИ страницы "Новости"'),
                ),
