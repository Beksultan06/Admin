...
class Media(models.Model):
    ...
    title_media = models.CharField(
        max_length=100,
        verbose_name='Заголовок СМИ страницы "Новости"'
    )
    description_media = RichTextField(
        verbose_name='Описание СМИ страницы "Новости"'
    )
    date_media = models.DateTimeField(
        verbose_name='Дата СМИ страницы "Новости"'
    )
    image_media = models.ImageField(
        upload_to='news/'
    )
    def __str__(self):
